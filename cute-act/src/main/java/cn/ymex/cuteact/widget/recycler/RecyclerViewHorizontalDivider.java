package cn.ymex.cuteact.widget.recycler;
 ...
 */
public class RecyclerViewHorizontalDivider extends RecyclerViewDividerDecoration {

    private MarginProvider mMarginProvider;

    protected RecyclerViewHorizontalDivider(Builder builder) {
        super(builder);
    ...
    public static class Builder extends RecyclerViewDividerDecoration.Builder<Builder> {
        ...
        public RecyclerViewHorizontalDivider build() {
            checkBuilderParams();
            return new RecyclerViewHorizontalDivider(this);
        }
    }
