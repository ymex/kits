...
public abstract class ViewHolderAdapter<E extends Object, V extends ViewHolderAdapter.ViewHolder> extends BaseAdapter {
    ...
    public void appendData(List<E> data) {
        if (Optional.isNull(data)) {
            Log.e(Kits.TAG_E, "At BaseCuteAdapter.appendData(): java.lang.NullPointerException: Attempt to invoke interface method 'java.lang.Object[] java.util.Collection.toArray()' on a null ");
            return;
        }
    ...
    public void resetData(List<E> data) {
        if (Optional.isNull(data)) {
            Log.e(Kits.TAG_E, "At BaseCuteAdapter.resetData(): java.lang.NullPointerException: Attempt to invoke interface method 'java.lang.Object[] java.util.Collection.toArray()' on a null ");
            return;
        }
