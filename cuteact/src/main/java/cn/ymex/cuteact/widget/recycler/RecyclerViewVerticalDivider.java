 ...
 */
public class RecyclerViewVerticalDivider extends RecyclerViewDividerDecoration {

    private MarginProvider mMarginProvider;

    protected RecyclerViewVerticalDivider(Builder builder) {
        super(builder);
    ...
    public static class Builder extends RecyclerViewDividerDecoration.Builder<Builder> {
        ...
        public RecyclerViewVerticalDivider build() {
            checkBuilderParams();
            return new RecyclerViewVerticalDivider(this);
        }
