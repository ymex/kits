 ...
 * @date 15/11/30
 */
public final class XPrinter extends Printer {
    ...
    private static final String TOP_BORDER_LINE    = "╔═════════════╤═══════════════════════════════";
    private static final String MIDDLE_BORDER_LINE = "╟─────────────┼───────────────────────────────";
    private static final String MIDDLE_END_LINE    = "╟─────────────┴───────────────────────────────";
    private static final String BOTTOM_BORDER_LINE = "╚═════════════════════════════════════════════";

    private static final String NULL_TOP_BORDER = "╔═════════════════════════════════════════════";
    ...
    public String logHeader() {
        ...
        if (element == null) {
            builder.append(NULL_TOP_BORDER + DOUBLE_DIVIDER + DOUBLE_DIVIDER);
            builder.append(NEXT_LINE);
            builder.append(HORIZONTAL_DOUBLE_LINE);
            builder.append("current stacktrace is  null");
            builder.append(NEXT_LINE);
            builder.append(BOTTOM_BORDER_LINE + DOUBLE_DIVIDER + DOUBLE_DIVIDER);
            return builder.toString().trim();
        }

        builder.append(TOP_BORDER_LINE + DOUBLE_DIVIDER + DOUBLE_DIVIDER);
        builder.append(NEXT_LINE);
        builder.append(HORIZONTAL_DOUBLE_LINE);
        builder.append(CLASS_DETAIL);
        builder.append(generateLinkMessage(element));
        builder.append(NEXT_LINE);


        builder.append(MIDDLE_BORDER_LINE + SINGLE_DIVIDER + SINGLE_DIVIDER);
        builder.append(NEXT_LINE);

        builder.append(HORIZONTAL_DOUBLE_LINE);
        builder.append(THREAD_DETAIL);
        ...
        builder.append(NEXT_LINE);
        builder.append(MIDDLE_END_LINE + SINGLE_DIVIDER + SINGLE_DIVIDER);
        return builder.toString().trim() + "\n";
    }
    ...
    public String logContent(Object message) {
        ...
        String[] texts = content.split(NEXT_LINE);
        StringBuilder builder = new StringBuilder();
        for (String text :
                texts) {
            builder.append(NEXT_LINE);
